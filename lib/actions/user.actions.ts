...
export const signUp = async ({password,...userData}: SignUpParams) => {
  ...
  try {
    ...
    if(!dwollaCustomerUrl) throw new Error("Failed to create Dwolla Customer Url")
    ...
    if(!newUser) throw new Error("Failed to create an user");
...
const createBankAccount = async ({
  ...
  try {
    ...
    if(!bankAccount) throw new Error("Failed to add bank account data")
